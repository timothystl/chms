...
export const CHMS_MANIFEST_JSON = '{"name":"Connect","short_name":"Connect","description":"Church management for Timothy Lutheran Church","start_url":"/","display":"standalone","theme_color":"#F3F7FA","background_color":"#F3F7FA","scope":"/","icons":[{"src":"/icons/icon-192.png","sizes":"192x192","type":"image/png","purpose":"any"},{"src":"/icons/icon-512.png","sizes":"512x512","type":"image/png","purpose":"any"},{"src":"/icons/icon-512-maskable.png","sizes":"512x512","type":"image/png","purpose":"maskable"}]}';
