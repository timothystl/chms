...
### v1.152.0 — Embedded / non-embedded marked on each plan, and the spread-cost model generalised (2026-08-07)

Follow-up to v1.151.0, working from the plan's own definition supplied by the church (non-embedded
