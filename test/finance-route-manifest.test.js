...
describe('Finance staging route manifest', () => {
  ...
  it('resolves only declared paths and methods', () => {
    ...
    expect(resolveFinanceRoute('/').optionalQueryBudgets).toEqual(['churchReport', 'balanceSheet', 'daycareReport', 'propertyReport', 'budgetReport', 'accountsReport', 'dataStatus', 'compensationReport']);
