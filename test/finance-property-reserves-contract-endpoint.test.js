...
const SEG = 'contracts/finance-property-reserves-v1';
...
describe('contracts/finance-property-reserves-v1 access gate', () => {
...
describe('contracts/finance-property-reserves-v1 real handler', () => {
  ...
  it('reflects real reserve/disbursement/distribution rows for the default (ivanhoe) property', async () => {
    const db = makeTestDb();
    ...
    expect(body.distributions).toEqual([{ period: '2026-04', amountCents: 500000 }]);
  });
