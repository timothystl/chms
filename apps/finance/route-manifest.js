...
const ROUTES = [
  { id: 'shell', paths: ['/', '/index.html'], dataSource: 'synthetic-d1', queryBudget: 'summary', optionalQueryBudgets: ['churchReport', 'balanceSheet', 'daycareReport', 'propertyReport', 'budgetReport'] },
